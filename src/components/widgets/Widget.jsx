    ...
    switch (type) {
        case "user": 
            data = {
                ...
                isMoney: false,
                link: "See all users",
                icon: <PermIdentityOutlinedIcon className="icon" style={{color: "crimson", backgroundColor: "rgb(255, 0, 0, 0.2"}}/>
            }; 
            break;
        ...
        case "order": 
            data = {
                ...
                icon: <ShoppingCartOutlinedIcon className="icon" style={{backgroundColor: "rgb(220, 165, 32, 0.2)", color: "goldenrod"}}/>
            }; 
            break; 
    ...
    return(
        <div className="widget">
            <div className="left">
                ...
                <span className="counter">{data.isMoney && <CurrencyRupeeIcon/>}{amount}</span>
